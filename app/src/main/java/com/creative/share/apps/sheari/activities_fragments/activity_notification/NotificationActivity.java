package com.creative.share.apps.sheari.activities_fragments.activity_notification;
...
import com.creative.share.apps.sheari.adapters.NotificationAdapter;
import com.creative.share.apps.sheari.databinding.ActivityNotificationBinding;
...
public class NotificationActivity extends AppCompatActivity implements Listeners.BackListener {
        ...
        binding.recView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 0) {
                    ...
                    if (total_item >= 13 && (last_item == (total_item - 1)) && !isLoading) {
    ...
    private void getData() {
        ...
        Call<NotificationDataModel> call;

        if (userModel.getData().getRole().equals("provider")) {
            call = Api.getService(Tags.base_url).getProviderNotification("Bearer " + userModel.getData().getToken(), 1);
        } else {
            call = Api.getService(Tags.base_url).getClientNotification("Bearer " + userModel.getData().getToken(), 1);
            ...
            public void onResponse(Call<NotificationDataModel> call, Response<NotificationDataModel> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    if (response.body().isValue()) {
                        ...
                        notificationModelList.addAll(response.body().getData().getNotifications());
    ...
    private void loadMore(int page) {
        ...
        if (userModel.getData().getRole().equals("provider")) {
            call = Api.getService(Tags.base_url).getProviderNotification("Bearer " + userModel.getData().getToken(), page);
        } else {
            call = Api.getService(Tags.base_url).getClientNotification("Bearer " + userModel.getData().getToken(), page);
