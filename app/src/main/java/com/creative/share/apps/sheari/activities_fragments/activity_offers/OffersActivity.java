package com.creative.share.apps.sheari.activities_fragments.activity_offers;
...
import com.creative.share.apps.sheari.databinding.ActivityOffersBinding;
                    ...
                    public void onResponse(Call<OfferDataModel> call, Response<OfferDataModel> response) {
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            if (response.body().isValue()) {
                                ...
                                Toast.makeText(OffersActivity.this, response.body().getMsg(), Toast.LENGTH_SHORT).show();
